...
that schedule. The sweep was measured under the hand-rolled schedule of that
time; `nn.learning_rates` states the same curve through optax now, and
`test_train.py` holds it against the closed form at every step. Measured 2026-08-24 at two ends of the ladder, over 1,500 steps,
