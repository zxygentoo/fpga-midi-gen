...
def make_eval(nll):
    """the jitted evaluation sums around an era's nll: over every step, and over the
    moving steps alone -- 77.91 percent of the voice slots repeat the step before, thus a
    drone scores well on the plain mean and the moving mean catches it"""
